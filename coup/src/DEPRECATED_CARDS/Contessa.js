...
// master function that calls decrement increment or changeR when something in changed (so i can compress code)

export default function Contessa({ data, setData, code }) {
